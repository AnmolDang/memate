...
import PlayBlackIcon from '../../assets/svg/PlayBlackIcon';
        ...
        <View style={styles.containerStyle}>
            ...
            <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('CompleteJob')} style={{ backgroundColor: '#DAFD90', width: '72%', borderRadius: 30, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={styles.headerViewStyle}>
                    ...
                    <View
                        ...
                        <Text style={styles.headerTextStyle}>In Progress</Text>
                        <Text style={styles.tamingStyle}>02:13</Text>
                    </View>
                </View>
