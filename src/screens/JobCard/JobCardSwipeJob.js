...
const JobCardSwipeJob = ({ navigation }) => {
        ...
        <View style={styles.containerStyle}>
            ...
            <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity {...panResponder.panHandlers} style={styles.swipeButton} onPress={() => navigation.navigate('JobSwipeDone')}>
...
export default JobCardSwipeJob;
